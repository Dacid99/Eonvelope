...
"""Delete signal receivers for the :class:`core.models.Daemon.Daemon` model."""
...
@receiver(pre_delete, sender=Daemon)
def pre_delete_stop_daemon(sender: Daemon, instance: Daemon, **kwargs: Any) -> None:
