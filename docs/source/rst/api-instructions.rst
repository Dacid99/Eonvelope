...
If you run a Emailkasten server or have access to one, the easiest way to get started with the API is via the redoc and swagger interfaces.

These can be found under http(s)://your.instance/api/schema/redoc and http(s)://your.instance/api/schema/swagger
