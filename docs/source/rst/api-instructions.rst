...
If you run a Eonvelope server or have access to one, the easiest way
...
The redoc interface for the user management API can be found under */api/auth/openapi.html*.
...
.. note::
    If you dont proxy Eonvelope and want to request the API, you will have to ignore the self-signed certificate warnings.
