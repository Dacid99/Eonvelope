...
Translation is done via `weblate <https://hosted.weblate.org/engage/eonvelope/>`_.
To get a quickstart look at :doc:`the translations instruction <translations>`.
If your language is also missing in `the languages available on weblate <https://hosted.weblate.org/projects/eonvelope/>`_,
