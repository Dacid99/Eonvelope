...
"""Test module for the :module:`Emailkasten.views.UserProfileView`."""
...
def test_get_noauth(client, login_url):
    """Tests `get` on :class:`Emailkasten.views.UserProfileView` for an unauthenticated user client."""
...
def test_get_auth_other(other_user, other_client):
    """Tests :class:`Emailkasten.views.UserProfileView` with the authenticated owner user client."""
...
def test_post_update_noauth(profile_payload, client, login_url):
    """Tests :class:`Emailkasten.views.UserProfileView` with an unauthenticated user client."""
...
def test_post_update_auth_other(other_user, profile_payload, other_client):
    """Tests :class:`Emailkasten.views.UserProfileView` with the authenticated other user client."""
