...
"""Test module for :mod:`api.v1.serializers.AccountSerializer`."""
...
def test_input(account_payload, request_context):
    ...
    serializer = AccountSerializer(data=account_payload, context=request_context)
...
def test_input__duplicate(fake_account, request_context):
    ...
    serializer = AccountSerializer(data=clean_payload, context=request_context)
