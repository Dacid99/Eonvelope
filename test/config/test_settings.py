...
"""Test module for the settings of Eonvelope."""
...
def test_eonvelope_logging(capsys, fake_message, production_logging):
    """Tests the eonvelope logger setup."""
    eonvelope_logger = logging.getLogger("eonvelope")

    eonvelope_logger.info(fake_message)

    assert fake_message in capsys.readouterr().err
    with open(LOG_DIRECTORY_PATH / "eonvelope.log") as logfile:
