...
def test_POP3Fetcher_connect_to_host_success(
    ...
    kwargs = {
        "host": pop3_mailbox.account.mail_host,
        "timeout": pop3_mailbox.account.timeout,
    }
    if mail_host_port:
...
@pytest.mark.django_db
def test_POP3Fetcher_test_mailbox_wrong_mailbox(
...
@pytest.mark.django_db
def test_POP3Fetcher_fetch_emails_wrong_mailbox(
...
def test_POP3Fetcher___str__(pop3_mailbox):
    """Tests :func:`core.utils.fetchers.POP3Fetcher.__str__`."""
