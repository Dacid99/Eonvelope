...
"""Test module for :mod:`Emailkasten.Serializers.MailingListSerializers.SimpleMailingListSerializer`."""
...
def test_output(mailingList):
    ...
    assert serializerData['correspondent'] == mailingList.correspondent.id
