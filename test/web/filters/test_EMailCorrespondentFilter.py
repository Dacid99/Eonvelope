...
"""Test module for :class:`web.filters.EMailCorrespondentFilter.EMailCorrespondentFilter`."""

import pytest

from web.filters.EMailCorrespondentFilter import EMailCorrespondentFilter
...
def test_text_search_filter(
    ...
    """Tests :class:`web.filters.EMailCorrespondentFilter.EMailCorrespondentFilter`'s filtering
    for the :attr:`core.models.CorrespondentModel.CorrespondentModel.text_search` field.
    """
    query = {"text_search": filterquery}

    filtered_data = EMailCorrespondentFilter(
