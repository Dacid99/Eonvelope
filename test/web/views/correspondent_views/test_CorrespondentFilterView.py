...
"""Test module for :mod:`web.views.correspondent_views.CorrespondentFilterView`."""
...
def test_get_noauth(client, list_url, login_url):
    ...
    assert response.url.endswith(f"?next={list_url(CorrespondentFilterView)}")
...
def test_get_auth_other(other_client, list_url):
    ...
    assert "correspondent/correspondent_filter_list.html" in [
