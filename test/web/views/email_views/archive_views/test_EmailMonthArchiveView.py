...
"""Test module for :mod:`web.views.EmailMonthArchiveView`."""
...
def test_get__noauth(client, fake_email, login_url, date_url):
    """Tests :class:`web.views.EmailMonthArchiveView` with an unauthenticated user client."""
    url = date_url(
...
def test_get__auth_other(other_client, fake_email, date_url):
    """Tests :class:`web.views.EmailMonthArchiveView` with the authenticated other user client."""
    ...
    assert "web/email/archive/month.html" in [
    ...
    assert "next_month" in response.context


@pytest.mark.django_db
def test_get__auth_owner(owner_client, fake_email, date_url):
    """Tests :class:`web.views.EmailMonthArchiveView` with the authenticated owner user client."""
...
def test_get__auth_admin(admin_client, fake_email, date_url):
    """Tests :class:`web.views.EmailMonthArchiveView` with the authenticated admin user client."""
