...
"""Test module for :mod:`web.views.email_views.EmailFilterView`."""
...
def test_get_noauth(client, list_url, login_url):
    """Tests :class:`web.views.email_views.EmailFilterView.EmailFilterView` with an unauthenticated user client."""
...
def test_get_auth_other(other_client, list_url):
    """Tests :class:`web.views.email_views.EmailFilterView.EmailFilterView` with the authenticated other user client."""
...
def test_get_auth_owner(owner_client, list_url):
    """Tests :class:`web.views.email_views.EmailFilterView.EmailFilterView` with the authenticated owner user client."""
