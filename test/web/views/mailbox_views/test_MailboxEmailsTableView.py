...
def test_get__auth_admin(fake_mailbox, admin_client, detail_url):
    """Tests :class:`web.views.MailboxEmailsTableView` with the authenticated admin user client."""
    response = admin_client.get(detail_url(MailboxEmailsTableView, fake_mailbox))
